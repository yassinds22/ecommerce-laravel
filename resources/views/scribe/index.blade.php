    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="products">
                    <a href="#products">Products</a>
                                ...
                                <a href="#products-GETapi-products--id-">Show a specific product.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This endpoint returns a list of all categories available in the store.</p>
...
<p>This endpoint returns a list of all products in the store.</p>
...
<p>This endpoint returns the details of a single product by ID.</p>
